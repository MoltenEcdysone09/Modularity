...
ba = sns.boxplot(ax=axs[0,1], data=mdf, x="Mean Connectivity", y="BC A", hue="Order")
...
bb = sns.boxplot(ax=axs[1,1], data=mdf, x="Order", y="BC A", hue="Mean Connectivity")
annotator = Annotator(bb, pairs, data=mdf, x="Order", y="BC A", hue="Mean Connectivity")
annotator.configure(test='Mann-Whitney', text_format='star').apply_and_annotate()
axs[1,1].set_ylim(0.2, 1.3)
axs[1,1].legend([],[], frameon=False)

ca = sns.boxplot(ax=axs[0,2], data=mdf, x="Mean Connectivity", y="ConPr", hue="Order")
axs[0,2].set_ylabel("Fraction of 01 & 10 States")
#annotator = Annotator(ba, pairs, data=mdf, x="Order", y="BC A", hue="Mean Connectivity")
#annotator.configure(test='Mann-Whitney', text_format='star').apply_and_annotate()
