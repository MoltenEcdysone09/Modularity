...
plt.tight_layout()
plt.savefig("S8Ai.svg",dpi=400)
plt.savefig("S8Ai.png",dpi=400, pad_inches=0)
plt.show()
...
plt.ylabel("log2(+ve InB/-ve InB)")
plt.tight_layout()
plt.savefig("S8Aii.svg",dpi=400)
plt.savefig("S8Aii.png",dpi=400, pad_inches=0)
plt.show()
...
plt.ylabel("log2(+ve InB/-ve InB)")
plt.tight_layout()
plt.savefig("S8Aiii.svg",dpi=400)
plt.savefig("S8Aiii.png",dpi=400, pad_inches=0)
plt.show()
