...
plt.scatter(mdf["InABR"], mdf["ConPr"], c=mdf["BCABR"],marker="o", cmap="Spectral", edgecolor="black", linewidth=0.7, alpha=0.8)
cbar = plt.colorbar()
...
plt.tight_layout()
plt.savefig("S2C.svg",dpi=400)
plt.savefig("S2C.png",dpi=400, pad_inches=0)
plt.show()
