...
plt.tight_layout()
plt.savefig("S8Bi.svg",dpi=400)
plt.savefig("S8Bi.png",dpi=400, pad_inches=0)
plt.show()
...
##plt.title("E = 2N BC>=0.55")
plt.tight_layout()
plt.savefig("S8Bii.svg",dpi=400)
plt.savefig("S8Bii.png",dpi=400, pad_inches=0)
plt.show()
...
##plt.title("E = 2N BC>=0.55")
plt.tight_layout()
plt.savefig("S8Biii.svg",dpi=400)
plt.savefig("S8Biii.png",dpi=400, pad_inches=0)
plt.show()
