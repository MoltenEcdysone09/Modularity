...
cb = sns.jointplot(data=mdf, x="In Degree of TT", y="CC BC", hue="Mean Connectivity", hue_order=["5N & E:2N","20N & E:2N", "E:2N" ,"E:4N", "E:6N"])
cb.ax_joint.axhline(-0.39, linewidth=3, color='r', linestyle = "-.")
cb.ax_joint.legend([],[], frameon=False)
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("S6Ci.svg",dpi=400)
plt.savefig("S6Ci.png",dpi=400, pad_inches=0)

cc = sns.jointplot(data=mdf, x="In Degree of TT", y="CC AC", hue="Mean Connectivity", hue_order=["5N & E:2N","20N & E:2N", "E:2N" ,"E:4N", "E:6N"])
cc.ax_joint.axhline(-0.39, linewidth=3, color='r', linestyle = "-.")
#cc.ax_joint.legend(title="Mean Connectivity",bbox_to_anchor=(1.5, 1), loc=2, borderaxespad=0.)
cc.ax_joint.legend([],[], frameon=False)
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("S6Cii.svg",dpi=400)
plt.savefig("S7Cii.png",dpi=400, pad_inches=0)
plt.show()


bb = sns.jointplot(data=mdf, x="In Degree of TT", y="BC B", hue="Mean Connectivity", hue_order=["5N & E:2N","20N & E:2N", "E:2N" ,"E:4N", "E:6N"])
bb.ax_joint.axhline(0.43, linewidth=3, color='r', linestyle = ":")
bb.ax_joint.legend([],[], frameon=False)
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("S6Ciii.svg",dpi=400)
plt.savefig("S6Ciii.png",dpi=400, pad_inches=0)

bc = sns.jointplot(data=mdf, x="In Degree of TT", y="BC C", hue="Mean Connectivity", hue_order=["5N & E:2N","20N & E:2N", "E:2N" ,"E:4N", "E:6N"])
bc.ax_joint.axhline(0.43, linewidth=3, color='r', linestyle = ":")
bc.ax_joint.legend([],[], frameon=False)
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("S6Civ.svg",dpi=400)
plt.savefig("S6Civ.png",dpi=400, pad_inches=0)
