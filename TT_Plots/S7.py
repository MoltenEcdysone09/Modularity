...
plt.savefig("S7B.svg",dpi=400)
plt.savefig("S7B.png",dpi=400, pad_inches=0)
...
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("S7C.svg",dpi=400)
plt.savefig("S7C.png",dpi=400, pad_inches=0)
plt.show()
...
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("S7E.svg",dpi=400)
plt.savefig("S7E.png",dpi=400, pad_inches=0)
...
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("S7F.svg",dpi=400)
plt.savefig("S7F.png",dpi=400, pad_inches=0)
