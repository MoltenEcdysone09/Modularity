...
ca.ax_joint.axhline(-0.39, linewidth=3, color='r', linestyle = "-.")
ca.ax_joint.legend([],[], frameon=False)
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("F6Bii.svg",dpi=400)
plt.savefig("F6Bii.png",dpi=400, pad_inches=0)


ba = sns.jointplot(data=mdf, x="In Degree of TT", y="BC A", hue="Mean Connectivity", hue_order=["5N & E:2N","20N & E:2N", "E:2N" ,"E:4N", "E:6N"])
ba.ax_joint.axhline(0.43, linewidth=3, color='r', linestyle = ":")
ba.ax_joint.legend([],[], frameon=False)
plt.tight_layout()
plt.subplots_adjust(wspace=0.0, hspace=0)
plt.savefig("F6Biii.svg",dpi=400)
plt.savefig("F6Biii.png",dpi=400, pad_inches=0)
